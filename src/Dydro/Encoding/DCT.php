...
/**
 * DCT encoding/decoding utility
 *
 * @package Dydro\Encoding
 */
class DCT implements EncodingInterface
{
    /**
     * Decodes a string from it's DCT-encoded equivalent
     *
    ...
    /**
     * Encoding a string to it's DCT-encoded equivalent
     *
