...
/**
 * CCITTFax encoding/decoding utility
 *
 * @package Dydro\Encoding
 */
class CCITTFax implements EncodingInterface
{
    /**
     * Decodes a string from it's CCITTFax-encoded equivalent
     *
    ...
    /**
     * Encoding a string to it's CCITTFax-encoded equivalent
     *
