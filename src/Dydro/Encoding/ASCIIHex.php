...
/**
 * ASCIIHex encoding/decoding utility
 *
 * @package Dydro\Encoding
 */
class ASCIIHex implements EncodingInterface
{
    /**
     * Decodes a string from it's ASCIIHex-encoded equivalent
     *
    ...
    /**
     * Encoding a string to it's ASCIIHex-encoded equivalent
     *
