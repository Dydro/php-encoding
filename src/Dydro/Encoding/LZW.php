...
/**
 * LZW encoding/decoding utility
 *
 * @package Dydro\Encoding
 */
class LZW implements EncodingInterface
{
    /**
     * Decodes a string from it's LZW-encoded equivalent
     *
    ...
    /**
     * Encoding a string to it's LZW-encoded equivalent
     *
