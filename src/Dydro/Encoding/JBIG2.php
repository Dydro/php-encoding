...
/**
 * JBIG2 encoding/decoding utility
 *
 * @package Dydro\Encoding
 */
class JBIG2 implements EncodingInterface
{
    /**
     * Decodes a string from it's JBIG2-encoded equivalent
     *
    ...
    /**
     * Encoding a string to it's JBIG2-encoded equivalent
     *
