...
/**
 * RunLength encoding/decoding utility
 *
 * @package Dydro\Encoding
 */
class RunLength implements EncodingInterface
{
    /**
     * Decodes a string from it's RunLength-encoded equivalent
     *
    ...
    /**
     * Encoding a string to it's RunLength-encoded equivalent
     *
