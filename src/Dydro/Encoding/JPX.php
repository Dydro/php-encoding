...
/**
 * JPX encoding/decoding utility
 *
 * @package Dydro\Encoding
 */
class JPX implements EncodingInterface
{
    /**
     * Decodes a string from it's JPX-encoded equivalent
     *
    ...
    /**
     * Encoding a string to it's JPX-encoded equivalent
     *
